...
set wildmode=longest,list,full          " Show full menu of options when typing a command

set nohlsearch 							" Search string will NOT stay highlighted
set noerrorbells 						" Disable the error bell
set noswapfile
" set undodir=~/.nvim/undodir
set undofile
set incsearch						    " Incremental search highlighting
set scrolloff=8							" Start scrolling down the file when I'm n lines away from the bottom
...
" --------------- Golang ---------------
let g:go_def_mapping_enabled = 0  " Delegate go to definition to coc.
